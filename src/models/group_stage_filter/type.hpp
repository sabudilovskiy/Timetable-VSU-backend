...
{
    convert::OptionalArrayProperty<SubString, "group_stage_ids"> group_stage_ids;
    convert::OptionalArrayProperty<std::int16_t, "group_stage_courses"> group_stage_courses;
    convert::OptionalProperty<TimeString, "group_stage_begin"> group_stage_begin; 
